package com.patterncat.lucene.spider;
...
class list{
    ...
    public String toString(){
        ...
        String ret="";
        for(node n = tail.getNext();n!=tail;n
                =n.getNext())ret+=n.getData().toString()+"\n";
...
class spider implements Runnable{
    ...
    String []badEndings3 = {"pdf", "txt", "zip", "jpg", "mpg", "gif",
            "mov", "tut", "req", "abs", "swf", "tex", "dvi", "bin", "exe", "rpm"};
    ...
    */
    private void parseFrame(URL at_page, String s) throws Exception{
        ...
        beg = s.indexOf("=", beg);
        if(beg==-1)throw new Exception("while parsing "
                +at_page.toString()+", bad frame, missing \'=\' after src: "+s);
        int start = beg;
    ...
    */
    private void parseLink(URL at_page, String s) throws Exception{
        ...
        beg = s.indexOf("=", beg);
        if(beg==-1)throw new Exception("while parsing "+at_page.toString()+
...
public class spidergui extends Frame{
    ...
    public static void main(String []args){
        ...
        for(int i=0;i<args.length;i++){
            ...
            else System.err.println("unrecognized switch: "+args+", continuing");
        }

        if(site == ""){
            System.err.println("No initial site parameter!");
            System.err.println("Use -init= switch to set, or -help for more info.");
            System.exit(1);
        }
