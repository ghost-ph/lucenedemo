...
public class InvertedIndex implements Index {
     ...
     * <P>
     * It is a hashtable of hashtables. The index for the outer hashtable (this
     * structure) is the term (stemmed word). The index for the inner hashtable
     * (the structure returned) is the document ID.
     */
    private HashMap<String,HashMap<String, int[]>> index;

    /** Initialize the Hashtable */
    public InvertedIndex() {
        index = new HashMap<String,HashMap<String, int[]>>();
    }

    /**
     * Build an inverted index based on a colllection of statistics about
     * documents.
     */
    ...
    /**
     * Register a frequency of a term within a document into this index. This
     * method is synchronized to allow for multiple threads to build the same
     * index concurrently without needing a synchronized data structure.
     *
     * @param docid
     *            The document ID
     * @param word
     *            The stemmed word
     * @param frequency
     *            The number of times word occurred in the document
     */
     ...
     *
     * @param filename
     *            The filename where this index will be stored
     */
     ...
     *
     * @param filename
     *            The filename where this index is stored.
     */
