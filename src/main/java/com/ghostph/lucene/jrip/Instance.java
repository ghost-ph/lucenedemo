package com.ghostph.lucene.jrip;
...
public class Instance implements Serializable {
    ...
    public/* @pure@ */Attribute attribute(int index) throws Exception {
     ...
     */
    // @ requires m_Dataset != null;
    public/* @pure@ */Attribute classAttribute() throws Exception {
        if (m_Dataset == null) {
            throw new Exception("Instance doesn't have access to a dataset!");
        }
    ...
    public/* @pure@ */int classIndex() throws Exception {
        if (m_Dataset == null) {
            throw new Exception("Instance doesn't have access to a dataset!");
        }
    ...
    public/* @pure@ */boolean classIsMissing() throws Exception {
        if (classIndex() < 0) {
     ...
     */
    // @ requires classIndex() >= 0;
    public/* @pure@ */double classValue() throws Exception {
     ...
     */
    // @ requires m_Dataset != null;
    public/* @pure@ */Enumeration enumerateAttributes() throws Exception {
     ...
     */
    // @ requires m_Dataset != null;
    public/* @pure@ */boolean equalHeaders(Instance inst) throws Exception {
     ...
     */
    // @ requires m_Dataset != null;
    public/* @pure@ */boolean hasMissingValue() throws Exception {
     ...
     */
    // @ requires m_Dataset != null;
    public/* @pure@ */int numClasses() throws Exception {
        if (m_Dataset == null) {
            throw new Exception("Instance doesn't have access to a dataset!");
        }
     ...
     *             if the dataset is not set
     * @throws IllegalArgumentException
     *             if the selected attribute is not nominal or a string, or the
     *             supplied value couldn't be found for a nominal attribute
     */
    // @ requires m_Dataset != null;
     ...
     * @throws Exception
     * @throws IllegalArgumentException
     *             if the attribute is not a nominal, string, date, or
     ...
     * @throws Exception
     */
    public final String toString(Attribute att) throws Exception {
    ...
    /**
     * Returns an instance's attribute value in internal format. Does exactly
     * the same thing as value() if applied to an Instance.
     *
     * @param indexOfIndex
     *            the index of the attribute's index
     * @return the specified value as a double (If the corresponding attribute
    ...
    public static void main(String[] options) {
        ...
        try {
            ...
            copy.setDataset(inst.dataset());
            System.out
                    .println("Copy with first attribute deleted and inserted: "
                            + copy);
