...
public class RuleStats
    ...
    public void countData(int index, Instances uncovered,
                          double[][] prevRuleStats) throws Exception{
        if((m_Filtered != null) ||
                (m_Ruleset == null))
            return;
    ...
    private Instances[] computeSimpleStats(int index, Instances insts,
                                           double[] stats, double[] dist) throws Exception{
     ...
     * @throws Exception
     */
    public void addAndUpdate(Rule lastRule) throws Exception{
        if(m_Ruleset == null)
    ...
    */
    ...
    public double minDataDLIfDeleted(int index, double expFPRate,
                                     boolean checkErr) throws Exception{
     ...
     * @throws Exception
     */
    public double relativeDL(int index, double expFPRate, boolean checkErr) throws Exception{
     ...
     * @throws Exception
     */
    public void reduceDL(double expFPRate, boolean checkErr) throws Exception{
	...
	*/
     ...
     * @throws Exception
     */
    public static final Instances stratify(Instances data, int folds, Random rand) throws Exception{
     ...
     * @throws Exception
     */
    public double combinedDL(double expFPRate, double predicted) throws Exception{
        double rt = 0;
